...
public class MyFirstTestcaseTest {
  ...
  public void myFirstTestcase() {
    ...
    driver.findElement(By.cssSelector(".post-160 .attachment-shop_catalog")).click();
    driver.findElement(By.linkText("Home")).click();
    driver.findElement(By.cssSelector(".attachment-shop_catalog:nth-child(2)")).click();
    driver.findElement(By.linkText("Home")).click();
    driver.findElement(By.cssSelector(".post-165 .attachment-shop_catalog")).click();
